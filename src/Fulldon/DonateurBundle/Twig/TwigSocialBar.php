...
namespace Fulldon\DonateurBundle\Twig;
...
// get the helper service and display the template
        return $this->container->get('fulldon.socialBarHelper')->socialButtons($render_parameters);
    }
...
// default values, you can override the values by setting them
        ...
        return $this->container->get('fulldon.socialBarHelper')->facebookButton($parameters);
    }
    ...
    public function getTwitterButton($parameters = array())
    {
        ...
        return $this->container->get('fulldon.socialBarHelper')->twitterButton($parameters);
    }
    ...
    public function getGooglePlusButton($parameters = array())
    {
        ...
        return $this->container->get('fulldon.socialBarHelper')->googlePlusButton($parameters);
    }
}