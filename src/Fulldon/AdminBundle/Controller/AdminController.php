...
class AdminController extends Controller
{
    public function indexAction()
    {
        ...
        return $this->render('FulldonAdminBundle:Admin:accueil.html.twig', array('users' => $users, 'roles' => $roles));
    }
    ...
    public function newUserAction()
    {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                ...
                if(!$this->isNewUser($user)) {
                    ...
                    return $this->redirect($this->generateUrl('fd_admin_user_new'));
                }
        ...
        return $this->render('FulldonAdminBundle:Admin:new.html.twig', array('form' => $form->createView()));
    }
    public function editUserAction($id)
    {
        ...
        return $this->render('FulldonAdminBundle:Admin:edit.html.twig', array('form' => $form->createView(), 'id'=> $id));
    }
